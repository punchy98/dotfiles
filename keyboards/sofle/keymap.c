...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LINUXSYM] = LAYOUT(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_GRV, KC_AT, KC_AMPR, KC_PLUS, KC_EQL, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, PGREP, KC_NO, KC_BSPC, KC_NO, KC_EXLM, KC_TILD, KC_LT, KC_GT, KC_HASH, KC_PIPE, KC_LPRN, KC_RPRN, KC_BSLS, KC_ASTR, KC_NO, KC_NO, KC_NO, KC_SLSH, KC_NO, DOUBLEARR, REV2ARR, KC_NO, KC_NO, KC_DLR, KC_LCBR, KC_RCBR, UPDIR, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TG(_LINUXSYM), KC_NO, KC_NO, KC_NO, KC_NO),
